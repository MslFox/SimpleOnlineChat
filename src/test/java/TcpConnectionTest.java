...
public class TcpConnectionTest {
    private final Socket socketMock = Mockito.mock(Socket.class, RETURNS_DEEP_STUBS);
    private final TCPConnectionHandler tcpConnectionHandlerMock = Mockito.mock(TCPConnectionHandler.class);
