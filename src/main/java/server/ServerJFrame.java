...
public class ServerJFrame {
        ...
        serverJFrame.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                if (answer == 0) {
                    ...
                    addToServiceLog("Server stopped!!! Closing connections...");
    ...
    public  synchronized void addToServiceLog(String message) {
        serverLogTextArea.append(messageToLogString(message));
        server.getServerChatLogger().addToServiceLog(messageToLogString(message));
            }

    public synchronized void addToChatLog(String message) {
        chatLogTextArea.append(messageToLogString(message));
        server.getServerChatLogger().addToChatLog(messageToLogString(message));
    }
}